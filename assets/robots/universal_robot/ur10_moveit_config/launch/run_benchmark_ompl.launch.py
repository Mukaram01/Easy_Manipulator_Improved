...
def generate_launch_description():
    ...
    kinematics_yaml = PathJoinSubstitution(
        [FindPackageShare("ur10_moveit_config"), "config", "kinematics.yaml"]
    )
    ompl_yaml = PathJoinSubstitution(
        [FindPackageShare("ur10_moveit_config"), "config", "ompl_planning.yaml"]
    )
    ...
    return LaunchDescription(
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution(
                        [FindPackageShare("ur10_moveit_config"), "launch", "planning_context.launch.py"]
                    )
                ),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution(
                        [FindPackageShare("ur10_moveit_config"), "launch", "warehouse.launch.py"]
                    )
                ),
                launch_arguments={
