...
def generate_launch_description():
    ...
    kinematics_yaml = PathJoinSubstitution(
        [FindPackageShare("ur3_moveit_config"), "config", "kinematics.yaml"]
    )
    ompl_yaml = PathJoinSubstitution(
        [FindPackageShare("ur3_moveit_config"), "config", "ompl_planning.yaml"]
    )
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution(
                        [FindPackageShare("ur3_moveit_config"), "launch", "planning_context.launch.py"]
                    )
                ),
