...
const cameraClicked = state.sceneJson.sensors.find(item => item.id === 'realsense_overhead');
const tableClicked = state.sceneJson.assets.find(item => item.id === 'support_surface_table');
