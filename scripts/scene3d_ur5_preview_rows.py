...
REQUIRED_UR5_VISUALS: tuple[dict[str, Any], ...] = (
    ...
    {"link": "shoulder_link", "mesh": "shoulder.dae", "xyz": [0.0, 0.0, 0.22], "rpy": [0.0, 0.0, 0.0], "parent": "base_link_inertia", "chain": ["world", "base_link_inertia", "shoulder_link"], "size": [0.20, 0.20, 0.28]},
    {"link": "upper_arm_link", "mesh": "upperarm.dae", "xyz": [0.25, 0.0, 0.43], "rpy": [0.0, 0.18, 0.0], "parent": "shoulder_link", "chain": ["world", "base_link_inertia", "shoulder_link", "upper_arm_link"], "size": [0.56, 0.12, 0.16]},
    {"link": "forearm_link", "mesh": "forearm.dae", "xyz": [0.68, 0.0, 0.37], "rpy": [0.0, -0.16, 0.0], "parent": "upper_arm_link", "chain": ["world", "base_link_inertia", "shoulder_link", "upper_arm_link", "forearm_link"], "size": [0.52, 0.11, 0.14]},
    {"link": "wrist_1_link", "mesh": "wrist1.dae", "xyz": [0.92, 0.0, 0.34], "rpy": [0.0, 0.0, 0.0], "parent": "forearm_link", "chain": ["world", "base_link_inertia", "shoulder_link", "upper_arm_link", "forearm_link", "wrist_1_link"], "size": [0.16, 0.11, 0.16]},
    {"link": "wrist_2_link", "mesh": "wrist2.dae", "xyz": [1.02, 0.0, 0.32], "rpy": [0.0, 0.0, 0.0], "parent": "wrist_1_link", "chain": ["world", "base_link_inertia", "shoulder_link", "upper_arm_link", "forearm_link", "wrist_1_link", "wrist_2_link"], "size": [0.14, 0.11, 0.13]},
    {"link": "wrist_3_link", "mesh": "wrist3.dae", "xyz": [1.10, 0.0, 0.32], "rpy": [0.0, 0.0, 0.0], "parent": "wrist_2_link", "chain": ["world", "base_link_inertia", "shoulder_link", "upper_arm_link", "forearm_link", "wrist_1_link", "wrist_2_link", "wrist_3_link"], "size": [0.12, 0.10, 0.11]},
)

STABLE_UR5_2F_PREVIEW_VISUALS: tuple[dict[str, Any], ...] = (
    {"link": "tool0", "mesh": "", "xyz": [1.16, 0.0, 0.32], "rpy": [0.0, 0.0, 0.0], "parent": "wrist_3_link", "chain": ["world", "base_link_inertia", "shoulder_link", "upper_arm_link", "forearm_link", "wrist_1_link", "wrist_2_link", "wrist_3_link", "tool0"], "size": [0.08, 0.08, 0.07], "category": "end_effector", "role": "end_effector", "preview_model": "robotiq_85"},
    {"link": "gripper_base_link", "mesh": "robotiq_85_base_link.dae", "mesh_prefix": "package://robotiq_85_description/meshes/visual/", "xyz": [1.22, 0.0, 0.32], "rpy": [0.0, 0.0, 0.0], "parent": "tool0", "chain": ["world", "base_link_inertia", "shoulder_link", "upper_arm_link", "forearm_link", "wrist_1_link", "wrist_2_link", "wrist_3_link", "tool0", "gripper_base_link"], "size": [0.12, 0.08, 0.10], "category": "end_effector", "role": "end_effector", "preview_model": "robotiq_85"},
    {"link": "gripper_finger1_finger_tip_link", "mesh": "robotiq_85_finger_tip_link.dae", "mesh_prefix": "package://robotiq_85_description/meshes/visual/", "xyz": [1.30, 0.045, 0.32], "rpy": [0.0, 0.0, 0.0], "parent": "gripper_base_link", "chain": ["world", "base_link_inertia", "shoulder_link", "upper_arm_link", "forearm_link", "wrist_1_link", "wrist_2_link", "wrist_3_link", "tool0", "gripper_base_link", "gripper_finger1_finger_tip_link"], "size": [0.12, 0.025, 0.08], "category": "end_effector", "role": "end_effector", "preview_model": "robotiq_85"},
