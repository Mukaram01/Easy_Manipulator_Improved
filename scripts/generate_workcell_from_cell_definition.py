...
def _is_existing_package_generator_owned_output(relative_path: Path) -> bool:
    ...
    files. Most generator-owned derived outputs live below ``generated/``.

    ``urdf/generated_asset_metadata.yaml`` is also explicitly generated by this
    tool and is part of the generated scene contract, so it must be refreshed
    during in-place regeneration as well.
    """
