...
def ensure_boost_stacktrace_guard() -> None:
    ...
    guard = [
        ...
        "  if(NOT BOOST_STACKTRACE_HEADER STREQUAL \"BOOST_STACKTRACE_HEADER-NOTFOUND\")",
        ...
        "  elseif(BOOST_STACKTRACE_HEADER STREQUAL \"BOOST_STACKTRACE_HEADER-NOTFOUND\")",
        "    message(WARNING \"Boost stacktrace headers not found; proceeding without stacktrace support\")",
        "  endif()",
        "endif()",
        end_marker,
        "",
