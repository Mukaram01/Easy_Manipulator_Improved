...
function(_tesseract_configure_meta_package)
  ...
  foreach(_tcmp_extra IN LISTS _TCMP_CFG_EXTRAS)
    ...
    if(NOT IS_ABSOLUTE "${_tcmp_extra_source}")
      set(_tcmp_binary_extra "${CMAKE_CURRENT_BINARY_DIR}/${_tcmp_extra_source}")
      if(EXISTS "${_tcmp_binary_extra}")
        set(_tcmp_extra_source "${_tcmp_binary_extra}")
      else()
        set(_tcmp_extra_source "${CMAKE_CURRENT_SOURCE_DIR}/${_tcmp_extra_source}")
      endif()
    endif()
  ...
  foreach(target ${_TCP_TARGETS})
    if(TARGET ${target})
      ...
      foreach(_tcp_extra IN LISTS _TCP_CFG_EXTRAS)
        ...
        if(NOT IS_ABSOLUTE "${_tcp_extra_source}")
          set(_tcp_binary_extra "${CMAKE_CURRENT_BINARY_DIR}/${_tcp_extra_source}")
          if(EXISTS "${_tcp_binary_extra}")
            set(_tcp_extra_source "${_tcp_binary_extra}")
          else()
            set(_tcp_extra_source "${_tcp_target_source_dir}/${_tcp_extra_source}")
          endif()
        endif()
