...
struct TaskIntentGrasp { std::string policy{"AUTO"}; std::string required_capability; std::string strategy_ref; std::string approach_axis; double approach_distance_m{0.0}; std::string orientation_mode; std::array<double, 3> tcp_offset_xyz_m{}; std::array<double, 3> tcp_offset_rpy_rad{}; double aperture_min_m{0.0}; double aperture_max_m{0.0}; bool contact_required{false}; std::string lift_axis; double lift_distance_m{0.0}; };
struct TaskIntentPlacement { std::string policy{"AUTO"}; std::string asset_ref; std::string region_ref; bool has_requested_local_pose{false}; TaskIntentPose requested_local_pose{}; std::string orientation_mode; std::array<double, 3> orientation_rpy_rad{}; std::string approach_axis; double approach_distance_m{0.0}; double clearance_m{0.0}; std::string retreat_axis; double retreat_distance_m{0.0}; };
